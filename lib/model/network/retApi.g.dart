...
class _RestClient implements RestClient {
  _RestClient(
    ...
    baseUrl ??= 'http://musemuse.eu-west-2.elasticbeanstalk.com';
  }
  ...
  Future<ResponseSignUp> signUp(RequestSignUp requestSignUp) async {
    ...
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ResponseSignUp>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<ResponseSignIn> signIn(RequestSignIn requestSignIn) async {
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(requestSignIn.toJson());
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<ResponseSignIn>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
